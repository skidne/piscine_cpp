...
{
	this->init("NinjaTrap");
	std::cout << "A strange NinjaTrap appeared" << std::endl;
}
...
NinjaTrap::NinjaTrap(NinjaTrap & r) : ClapTrap(r)
{
	this->hitP = r.hitP;
...
{
	std::cout	<< "NinjaTrap " << this->name << " attacks " << target << " at range, causing " 
				<< this->rangedAttackDmg << " points of damage !" << std::endl;
}

void	NinjaTrap::meleeAttack(std::string const & target)
{
	std::cout	<< "NinjaTrap " << this->name << " attacks " << target << " with melee, causing " 
